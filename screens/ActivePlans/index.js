...
const Item = ({ title }) => (
  <View style={styles.cardContainer}>
    <View style={styles.titleCont}>
      ...
      <Image
        source={images.edit}
        style={{ height: SIZES.width / 33, width: SIZES.width / 33, marginLeft: SIZES.width / 50 }}
      />
    </View>
    <View><Text style={styles.cardSubTitle}>{'\u20B9'} 1000</Text></View>
    <View><Text style={styles.cardText1}>Plan validity till : 6th Sept 2026</Text></View>
    <View><Text style={styles.cardText2}>Number of Years : 5 years</Text></View>
    <View><Text style={styles.cardText3}>Number of People : 10 years</Text></View>
  </View>
);
